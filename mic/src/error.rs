...
/// The main error type for mic operations.
#[derive(Error, Debug)]
pub enum MicError {
    // =========================================================================
    ...
    #[error("Not authenticated. Run 'mic auth login' first.")]
    NotAuthenticated,

    #[error("Access token expired. Run 'mic auth login' again.")]
    TokenExpired,

    #[error("Invalid stored token data. Run 'mic auth login' again.")]
    InvalidTokens,
    ...
    #[error("No default server configured. Add one with 'mic config set-server'.")]
    NoDefaultServer,
    ...
    #[error("Session already active. Run 'mic session status' to see it or 'mic session abandon' to discard it.")]
    SessionAlreadyActive,

    #[error("No active session. Start one with 'mic session start'.")]
    NoActiveSession,
    ...
    #[error("No workspace found. Run 'mic checkout' or 'mic link' first.")]
    NoWorkspace,
...
/// Result type alias for mic operations.
